...
public class VehicleController {
	...
	@PostMapping("/add/{did}")
	public SuccessMessageDto addVehicle(@RequestBody VehicleDto vehicleDto,@PathVariable Integer did) throws ValidateVehicleException, DriverIdException {
		Vehicle vehicle=vehicleService.addVehicle(vehicleDto,did);
